...
## LEDs
set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { LED_rst }]; #IO_L24N_T3_35 Sch=led[4]
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { SCK }]; #IO_0_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { MISO }]; #IO_L4P_T0_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { MOSI }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { CSn }]; #IO_L6P_T0_15 Sch=ja[4]
...
set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { rstn }]; #IO_L16P_T2_35 Sch=ck_rst
...
#set_input_delay -clock [get_clocks virtual_clock] -max -add_delay 1.000 [get_ports {sw[0]}]
#set_output_delay -clock [get_clocks virtual_clock] -min -add_delay 1.000 [get_ports led0_r]
#set_output_delay -clock [get_clocks virtual_clock] -max -add_delay 1.000 [get_ports led0_r]
#set_input_delay -clock [get_clocks virtual_clock] -min -add_delay 1.000 [get_ports {sw[1]}]
#set_input_delay -clock [get_clocks virtual_clock] -max -add_delay 1.000 [get_ports {sw[1]}]
#set_output_delay -clock [get_clocks virtual_clock] -min -add_delay 1.000 [get_ports led0_g]
#set_output_delay -clock [get_clocks virtual_clock] -max -add_delay 1.000 [get_ports led0_g]
#set_input_delay -clock [get_clocks virtual_clock] -min -add_delay 1.000 [get_ports {sw[2]}]
#set_input_delay -clock [get_clocks virtual_clock] -max -add_delay 1.000 [get_ports {sw[2]}]
#set_output_delay -clock [get_clocks virtual_clock] -min -add_delay 1.000 [get_ports led0_b]
#set_output_delay -clock [get_clocks virtual_clock] -max -add_delay 1.000 [get_ports led0_b]
