...
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { CSn }]; #IO_L4P_T0_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { MISO }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { MOSI }]; #IO_L6P_T0_15 Sch=ja[4]
